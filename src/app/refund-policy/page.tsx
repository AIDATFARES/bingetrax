...
const sections = [
  {
    ...
    content: [
      "At BINGETRAX IPTV, we uphold the standard of our IPTV subscription service. This policy specifies when refunds may be applicable, ensuring that we maintain a transparent and just process for every customer.",
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      <>Connect with our support team using our <Link className="font-semibold text-primary-400 hover:text-primary-300" href="/contact">Contact page</Link>.</>,
  ...
  },
  {
    ...
    content: [
      <>Contact: Send a message via our <Link className="font-semibold text-primary-400 hover:text-primary-300" href="/contact">Contact page</Link></>,
  ...
  },
  {
    ...
    items: [
      <>You are discontent with the <Link className="font-semibold text-primary-400 hover:text-primary-300" href="/channels">channel list</Link> or provided content.</>,
  ...
  },
  {
    ...
    items: [
      ...
      <>Use Setup Guides: Follow our step by step <Link className="font-semibold text-primary-400 hover:text-primary-300" href="/installation">Installation page</Link>.</>,
      <>Ask Support First: Most issues are solved in minutes—please <Link className="font-semibold text-primary-400 hover:text-primary-300" href="/contact">contact support</Link>.</>,
    ],
  },
];
