...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: (
      <>
        Start by installing a compatible IPTV player on your device. Enter the BINGETRAX credentials from your email or WhatsApp. View our step-by-step <Link href="/installation" className="text-primary-500 font-semibold hover:text-primary-400 transition-colors">installation guides</Link> for detailed instructions.
      </>
    ),
  },
  {
