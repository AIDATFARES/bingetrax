  ...
  return <section className="relative overflow-hidden bg-white py-24 sm:py-28">
    ...
    <div className="relative mx-auto max-w-[1120px] px-5 sm:px-8">
      <div className="mx-auto mb-14 max-w-3xl text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-sm leading-6 text-slate-600">Everything you need for premium live television and on-demand entertainment with BINGETRAX—on any device, anywhere in the world.</p>
      </div>
